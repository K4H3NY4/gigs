		...
		<div class="row">
			<div class="col-md-12">
				<div class="single-page-header-inner">
					<div class="left-side">
						<div class="header-image freelancer-avatar"><img src="<?php echo $user ["photo"];?>" alt=""></div>
						<div class="header-details">
							<h3 class="text-capitalize"><?php echo $user ["firstName"]. " ". $user ["lastName"] ;?> <span><?php echo $user ["tagline"];?></span></h3>
							<ul>
								<li>Nationality : <?php echo $user ["nationality"];?></li>
								<li><div class="verified-badge-with-title"><?php echo $user ["accountType"];?></div></li>
							</ul>
						</div>
					</div>
				</div>
	...
	<div class="row">
		...
		<div class="col-xl-8 col-lg-8 content-right-offset">
			...
			<div class="single-page-section">
				...
				<p align="justify"><?php echo $user ["bio"];?></p>
			</div>
		...
		<div class="col-xl-4 col-lg-4">
			<div class="sidebar-container">
				...
				<!-- Button -->
				<a href="single-freelancer-profile.html#small-dialog" class="apply-now-button popup-with-zoom-anim margin-bottom-50">Make an Offer <i class="icon-material-outline-arrow-right-alt"></i></a>
				...
				<div class="sidebar-widget">
					...
					<div class="freelancer-socials margin-top-25">
						<ul>
							...
							<li><a href="single-freelancer-profile.html#" title="Twitter" data-tippy-placement="top"><i class="icon-brand-twitter"></i></a></li>
					...
					<div class="share-buttons margin-top-25">
						...
						<div class="share-buttons-content">
							...
							<ul class="share-buttons-icons">
								<li><a href="single-freelancer-profile.html#" data-button-color="#3b5998" title="Share on Facebook" data-tippy-placement="top"><i class="icon-brand-facebook-f"></i></a></li>
								<li><a href="single-freelancer-profile.html#" data-button-color="#1da1f2" title="Share on Twitter" data-tippy-placement="top"><i class="icon-brand-twitter"></i></a></li>
								<li><a href="single-freelancer-profile.html#" data-button-color="#dd4b39" title="Share on Google Plus" data-tippy-placement="top"><i class="icon-brand-google-plus-g"></i></a></li>
								<li><a href="single-freelancer-profile.html#" data-button-color="#0077b5" title="Share on LinkedIn" data-tippy-placement="top"><i class="icon-brand-linkedin-in"></i></a></li>
							</ul>
						</div>
					</div>
				</div>
